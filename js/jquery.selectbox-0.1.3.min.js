...
(function($, undefined) {
    ...
    function Selectbox() {
        this._state = [];
        this._defaults = {classHolder:"sbHolder",classHolderDisabled:"sbHolderDisabled",classSelector:"sbSelector",classOptions:"sbOptions",classGroup:"sbGroup",classSub:"sbSub",classDisabled:"sbDisabled",classToggleOpen:"sbToggleOpen",classToggle:"sbToggle",speed:500,effect:"slide",onChange:null,onOpen:null,onClose:null}
    }
    ...
    $.extend(Selectbox.prototype, {_isOpenSelectbox:function(target) {
        ...
        sbHolder = $("<div>", {id:"sbHolder_" + inst.uid,"class":inst.settings.classHolder});
        ...
        function getOptions() {
            ...
            arguments[0].each(function(i) {
                ...
                if (!that.is(":disabled") && !disabled) {
                    child = $("<a>", {href:"#" + that.val(),rel:that.val(),text:that.text(),click:function(e) {
                        e.preventDefault();
                        var t = sbToggle,uid = t.attr("id").split("_")[1];
        ...
        var inst = this._getInst(target),onChange = this._get(inst, "onChange");
